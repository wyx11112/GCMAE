...
def adj_heatmap(ori_adj, res_adj):
    fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(15, 5))
    sns.heatmap(ori_adj, cmap="PuBu", ax=ax1)
    sns.heatmap(res_adj, cmap="PuBu", ax=ax2)
    plt.show()
...
def build_args():
    ...
    parser.add_argument("--max_epoch_lp", type=int, default=200,
                        help="number of lp epochs")
    ...
    parser.add_argument("--num_projector_hidden", type=int, default=256,
                        help="number of projector hidden units")
    parser.add_argument("--num_projector", type=int, default=256,
                        help="number of projector units")
    ...
    parser.add_argument("--weight_decay", type=float, default=5e-4,
                        help="weight decay")
    parser.add_argument("--weight_decay_lp", type=float, default=2e-4,
                        help="weight decay for lp")
